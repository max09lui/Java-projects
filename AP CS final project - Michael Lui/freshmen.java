import java.util.*;
public class freshmen extends students
{
    ...
    public freshmen(String name, String address, String number, int age, double tscore, double twhole)
    {
    ...
    {
        return "math 1, science 1, english 1, history 1";
        //required class for freshemen
    }
    public int grade()
    {
        return 9;
    ...
    public String toString()
    {
        ...
        return ("name: "+studentname+" address: "+studentaddress+" phonenumber: "+completednumber+"\nage: "+studentage+" current grade percentage is "+totalscore/totalwhole*100+"% "+"current letter grade is "+lettergrade(totalscore,totalwhole ));
    }
